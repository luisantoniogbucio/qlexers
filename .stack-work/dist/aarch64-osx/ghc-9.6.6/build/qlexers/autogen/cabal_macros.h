...
/* package qlexers-0.1.0.0 */
#ifndef VERSION_qlexers
#define VERSION_qlexers "0.1.0.0"
#endif /* VERSION_qlexers */
#ifndef MIN_VERSION_qlexers
#define MIN_VERSION_qlexers(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_qlexers */
...
#define CURRENT_COMPONENT_ID "qlexers-0.1.0.0-6rdR7YDqHapLxFHElxrZB5-qlexers"
