...
/* package lexer-imp-0.1.0.0 */
#ifndef VERSION_lexer_imp
#define VERSION_lexer_imp "0.1.0.0"
#endif /* VERSION_lexer_imp */
#ifndef MIN_VERSION_lexer_imp
#define MIN_VERSION_lexer_imp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_lexer_imp */
...
#define CURRENT_COMPONENT_ID "lexer-imp-0.1.0.0-inplace-lexer-imp"
